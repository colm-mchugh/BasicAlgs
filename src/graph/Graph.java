...
public interface Graph<T> {
    ...
    /**
     * Add an edge between vertices from and to. Post conditions: 1) from and to
     * are both in the graph (if they weren't already) 2) the graph contains the
     * edge: from -> to
     *
     * @param from
     * @param to
    ...
    /**
     * Return all the objects that a given vertex 'from' has edges with, in
     * other words all the vertices it is connected to.
     *
     ...
     * s.t. S1 intersection S2 == {} AND S1 U S2 == V() and N is the number of
     ...
     * return a copy of itself with all edges reversed. An undirected graph will
     * return itself.
     *
     * @return
     */
